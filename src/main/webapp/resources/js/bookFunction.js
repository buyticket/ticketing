...
{
	// jQuery 로 사용할 때 방법
	// if($("#book_kind option:selected").val())	<= id  값으로 비교할 때
	...
	if(!bookRegisterForm.book_content.value) {
		alert("책의 내용을 입력하십시오.");
		bookRegisterForm.book_content.focus();
		return false;
	}
...
} // End - function checkBookRegisterForm(bookRegisterForm)
